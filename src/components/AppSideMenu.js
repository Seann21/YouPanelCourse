...
export default function AppSideMenu(){
    ...
    const menuItems = [
        ...
        {type: "divider"},
        {label:<Link href="/courses">Course</Link>,key:3},
        {label:<Link href="/tutorials">Tutorial</Link>,key:4},
        {label:<Link href="/best-practices">Best Practices</Link>,key:5},
        {label:<Link href="/certifications">Certification</Link>,key:6},
        {label:<Link href="/resources">Resources</Link>,key:7},
        {label:<Link href="/event">Events</Link>,key:8},
